...
4:30 PM - 6:00 PMFinance
 ...
 ![TRMNL Logo](/images/plugins/trmnl--render.svg)OverflowGeneric Container
...
Place `.item`[Item](/framework/docs/3.3/item) elements inside a single `.column` element, that's nested inside a `.columns`[Columns](/framework/docs/3.3/columns) container. Set the exact or maximum number of columns with `data-overflow-cols` or `data-overflow-max-cols`.
...
4:30 PM - 6:00 PMFinance
 ...
 ![TRMNL Logo](/images/plugins/trmnl--render.svg)OverflowExactly 3 Columns
...
4:30 PM - 6:00 PMFinance
 ...
 ![TRMNL Logo](/images/plugins/trmnl--render.svg)OverflowMax 3 Columns
...
4:30 PM - 6:00 PMFinance
 ...
 ![TRMNL Logo](/images/plugins/trmnl--render.svg)OverflowHeight Budget (220px)
...
4:30 PM - 6:00 PMFinance
 ...
 ![TRMNL Logo](/images/plugins/trmnl--render.svg)OverflowCounter Enabled
...
The Clamp engine [Clamp](/framework/docs/3.3/clamp) re-clamps text for the actual column width. Apply `data-clamp` on titles or descriptions as needed.
...
4:30 PM - 6:00 PMFinance
 ...
 ![TRMNL Logo](/images/plugins/trmnl--render.svg)Overflow + ClampTitle 1 • Description 3 • Max 2 Columns
...
4:30 PM - 6:00 PMFinance
 ...
 ![TRMNL Logo](/images/plugins/trmnl--render.svg)Group HeadersSmart Distribution
...
FridayRetrospective
 ...
 ![TRMNL Logo](/images/plugins/trmnl--render.svg)OverflowHarmonious Groups 3 Columns (2/3/2)
...
4:30 PM - 6:00 PMFinance
 ...
 ![TRMNL Logo](/images/plugins/trmnl--render.svg)OverflowWith dividers
...
4:30 PM - 6:00 PMFinance
 ...
 ![TRMNL Logo](/images/plugins/trmnl--render.svg)OverflowLegacy attributes
...
Handle table rows overflow
 ...
 ](/framework/docs/3.3/table_overflow)
