...
Need a specific dimension? Use arbitrary size classes for precise pixel values with `w--[Npx]` and `h--[Npx]` syntax, where N can be any value from 0 to 128. Responsive prefixes work here (`md:w--[96px]`), unlike the arbitrary values on [Gap](/framework/docs/3.3/gap) and [Rounded](/framework/docs/3.3/rounded) .
...
Auto Width
 ...
 ![TRMNL Logo](/images/plugins/trmnl--render.svg)SizeDynamic Widths
...
Max Width 32 (128px)
 ...
 ![TRMNL Logo](/images/plugins/trmnl--render.svg)SizeFixed Sizes
...
Responsive Height
 ...
 ![TRMNL Logo](/images/plugins/trmnl--render.svg)SizeResponsive Sizes
...
Run the framework locally, find your way around, run the tests, and open a good pull request
 ...
 ](/framework/docs/3.3/contributing)
