...
| Pete Miller | Sales | 0 | 0 | 0.00 | Nickname: Plop |
 ...
 ![TRMNL Logo](/images/plugins/trmnl--render.svg)TableRegular
...
| 30 | Pete Miller | Sales | 0 | 0 | 0.00 | Nickname: Plop |
 ...
 ![TRMNL Logo](/images/plugins/trmnl--render.svg)TableIndexed
...
Tables support five sizes: Base, Large, XLarge, Small, and XSmall. Use modifier classes to change row heights. Size and orientation prefixes both apply, so `lg:portrait:table--xlarge` raises the row height only on large portrait screens (see the [Responsive](/framework/docs/3.3/responsive) docs).
...
| Pete Miller | Sales | 0 | 0 | 0.00 | Nickname: Plop |
 ...
 ![TRMNL Logo](/images/plugins/trmnl--render.svg)TableBase
...
| Pete Miller | Sales | 0 | 0 | 0.00 | Nickname: Plop |
 ...
 ![TRMNL Logo](/images/plugins/trmnl--render.svg)TableLarge
...
| Pete Miller | Sales | 0 | 0 | 0.00 | Nickname: Plop |
 ...
 ![TRMNL Logo](/images/plugins/trmnl--render.svg)TableXLarge
...
| Pete Miller | Sales | 0 | 0 | 0.00 | Nickname: Plop |
 ...
 ![TRMNL Logo](/images/plugins/trmnl--render.svg)TableSmall
...
| Pete Miller | Sales | 0 | 0 | 0.00 | Nickname: Plop |
 ...
 ![TRMNL Logo](/images/plugins/trmnl--render.svg)TableXSmall
...
Demonstrates the Overflow behavior [Table Overflow](/framework/docs/3.3/table_overflow) and trailing "and X more" row when content exceeds the height budget.
...
| Pete Miller | Sales | 0 | 0 | 0.00 | Nickname: Plop |
 ...
 ![TRMNL Logo](/images/plugins/trmnl--render.svg)TableOverflow
...
Apply `data-clamp`[Clamp](/framework/docs/3.3/clamp) to each cell's content to ensure consistent single-line truncation with ellipsis. This works with the Table Overflow behavior [Table Overflow](/framework/docs/3.3/table_overflow) .
...
| Pete Miller | Sales | 0 | 0 | 0.00 | Nickname: Plop |
 ...
 ![TRMNL Logo](/images/plugins/trmnl--render.svg)TableClamp: 1 line
