...
When content exceeds the available height, Columns doesn't break or overflow. It gracefully hides items that don't fit and, when configured, adds an "and X more" indicator so users know there's additional content. See the [Overflow](/framework/docs/3.3/overflow) page for details.
...
Item
 ...
 ![TRMNL Logo](/images/plugins/trmnl--render.svg)Columns
...
1:1
 ...
 ![TRMNL Logo](/images/plugins/trmnl--render.svg)Columnscolumns--center
